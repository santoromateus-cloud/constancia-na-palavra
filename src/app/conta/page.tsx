  ...
  return (
    <main className="conta-wrap">
      <header className="conta-head">
        <a className="conta-logo" href="/">
          <svg width="34" height="34" viewBox="0 0 64 64">
            <rect width="64" height="64" rx="16" fill="#2f4858" />
      ...
      <style>{`
        ...
        .conta-card{max-width:560px;margin:0 auto;background:var(--paper);border:1px solid #e3ddd2;border-radius:18px;padding:clamp(22px,4vw,36px);box-shadow:var(--shadow-sm)}
        ...
        .conta-plano-mensal{color:#2a9d8f}
        .conta-status{margin-left:8px;font-size:12px;padding:2px 9px;border-radius:99px;background:#eaf5f2;color:#2a9d8f;white-space:nowrap}
        ...
        .conta-btn-treinar{display:block;text-align:center;background:var(--ink);color:#fff;font-weight:600;border-radius:14px;padding:14px;transition:.2s}
